...
namespace KokkosResilience
{
  ...
  public:
    ...
    virtual void register_hashes(const std::vector< std::unique_ptr< Kokkos::Experimental::ViewHolderBase > > &views,
    ...
    virtual void restart( const std::string &label, int version,
                          const std::vector< std::unique_ptr< Kokkos::Experimental::ViewHolderBase > > &views ) = 0;
